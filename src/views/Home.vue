...
export default {
    data() {
        return {
            carouselItem: [  //轮播图
                {
                    name: 'img1',
                    imgSrc: 'https://wx3.sinaimg.cn/large/59853be1ly1g94pzbueftj20f408ijx9.jpg'
                },{
                    name: 'img2',
                    imgSrc: 'https://wx4.sinaimg.cn/large/59853be1ly1g94pzrv0fwj20f408i7bj.jpg'
                },{
                    name: 'img3',
                    imgSrc: 'https://wx1.sinaimg.cn/large/59853be1ly1g94oyanpa0j20f408igu6.jpg'
                }
            ],
            hotProducts:[ //热门商品
                {
    ...
    created(){
        // var url1 = 'http://www.yunyi.com/getList',
